...
1.  Create a subset from `composition_tidy` containing observations for countries classified as high-income countries or low-income countries, and countries with other waste composition greater than 40%.
...
-   "low income" if `income_id` is "LIC"
...
6.  Store the result as a new object in your environment with the name `composition_tidy_capita_income_cat`
